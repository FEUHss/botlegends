...
def inicializar_banco():
    tabelas = [
        ...
        CREATE TABLE IF NOT EXISTS loot_evidencias (
            ...
            monstro_id BIGINT REFERENCES catalogo_monstros(id),
        ...
        CREATE TABLE IF NOT EXISTS item_drop_relacoes (
            ...
            mapa_id BIGINT REFERENCES catalogo_mapas(id),
            forma_obtencao TEXT,
            primeira_evidencia_id BIGINT REFERENCES loot_evidencias(id),
            ultima_evidencia_id BIGINT REFERENCES loot_evidencias(id),
